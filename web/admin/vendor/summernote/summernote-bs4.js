...
var ui = {
    ...
    button: function ($node, options) {
        return renderer.create('<button type="button" class="note-btn btn btn-white btn-sm" role="button" tabindex="-1">', function ($node, options) {
...
$$1.summernote = $$1.extend($$1.summernote, {
    ...
    options: {
        modules: {
            ...
            'handle': Handle,
            // FIXME: HintPopover must be admin of autolink
